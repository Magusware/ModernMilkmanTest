namespace CustomerServiceNS.Tests
{
    ...
    public class AutoDomainDataAttribute : AutoDataAttribute
    {
        ...
        private static IFixture CreateFixture()
        {
            ...
            fixture.Customize<Database.Address>(customization =>
            {
                return customization
                    ...
                    .Without(x => x.Country)
                    .Without(customer => customer.Customer)
                    .Do(x =>
                    {
            ...
            fixture.Customize<Interfaces.Address>(customization =>
            {
                return customization
                    .Without(x => x.AddressLine1)
                    .Without(x => x.AddressLine2)
            ...
            fixture.Customize<Interfaces.Customer>(customization =>
            {
                return customization
                    .Without(x => x.Title)
                    .Without(x => x.Forename)
